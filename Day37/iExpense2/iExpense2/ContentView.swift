    ...
    var body: some View {
        NavigationStack {
            ...
            List {
                ...
                ForEach(expensesAh.items) { item in // Buradaki \.id ExpenseItem property olandır. ExpenseItem structuna Identifiable protocol sağladığımız için burada id: kullanmaya gerek kalmadı.
                    HStack {
...
//                    let expense = ExpenseItem(name: "Test", type: "Personal", amount: 61)
